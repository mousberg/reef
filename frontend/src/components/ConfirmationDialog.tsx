...
export function ConfirmationDialog({
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center transition-all duration-200 ${
      ...
      {/* Dialog */}
      <div className={`relative bg-white rounded-[24px] shadow-[0px_0px_0px_4px_rgba(55,50,47,0.05)] border border-[rgba(2,6,23,0.08)] p-8 mx-4 max-w-md w-full transition-all duration-200 ${
        ...
        <div className="text-center">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <Button
              onClick={() => {
                console.log("Confirmation button clicked, calling onConfirm...")
                onConfirm()
              }}
              disabled={loading}
