...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "In just a few minutes, we built and deployed our first AI agent. The visual builder made it incredibly intuitive and powerful!",
      name: "Jamie Marshall",
    ...
    {
      quote:
        "Reefs has revolutionized how we build AI agents. What used to take weeks now takes hours, and the agents actually understand our users.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "The agent orchestration is a game-changer. We can deploy complex multi-agent systems that handle thousands of conversations daily.",
      name: "Marcus Rodriguez",
      company: "AI Lead, InnovateCorp",
      image:
