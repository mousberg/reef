        ...
        <div className="relative bg-white rounded-lg shadow-lg border border-[#e0dedb] overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 border-b border-[#e0dedb]">
            <div className="flex items-center gap-3">
              <div className="text-[#37322f] font-semibold">Reefs</div>
          ...
          <div className="flex">
            ...
            <div className="w-48 bg-[#fbfaf9] border-r border-[#e0dedb] p-4">
              <nav className="space-y-2">
                ...
                {["Home", "Agents", "Workflows", "Analytics", "Deployments", "Settings"].map((item) => (
            ...
            <div className="flex-1 p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-title text-xl font-semibold text-[#37322f]">AI Agents</h2>
                <Button className="bg-[#37322f] hover:bg-[#37322f]/90 text-white text-sm">Create agent</Button>
              </div>
                ...
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className="grid grid-cols-6 gap-4 p-4 border-b border-[#e0dedb] text-sm">
                    ...
                    <div>
                      ...
                      >
                        {i % 3 === 0 ? "Running" : i % 3 === 1 ? "Active" : "Idle"}
                      </span>
                    </div>
                    <div className="text-[#605a57]">Customer Support</div>
