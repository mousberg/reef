    ...
    def do_POST(self) -> None:  # noqa: N802 (BaseHTTPRequestHandler API)
        ...
        if tool_key == "user-input-request":
            ...
            user_input = os.getenv(
                "QUICKSTART_USER_INPUT",
                "Get the weather in Amsterdam" # "What is your name? Please answer with just your first name.",
            )
...
def build_agent_graph_request_from_toml(tool_base_url: str, agent_toml_paths: list[str]) -> dict:
    ...
    for toml_path in agent_toml_paths:
        ...
        for option_key, option_spec in options_table.items():
            ...
            print(f"Option key: {option_key}, Option type: {option_type}, Default value: {default_value}, Environment value: {env_value}")
...
if __name__ == "__main__":
    main(["agents/interface/coral-agent.toml",
          "agents/weather/coral-agent.toml"]
    )
